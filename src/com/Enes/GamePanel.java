...
public class GamePanel extends JPanel implements ActionListener{
    ...
    public void gameOver(Graphics g) {
        //Game over screen with SCORE BOARD text
        g.setColor(Color.red);
        ...
        g.drawString("Play Again", (SCREEN_WIDTH-metrics3.stringWidth("Play Again"))/4, SCREEN_WIDTH/4);
